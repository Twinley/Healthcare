...
<form action="processlogindoc.php" method="post">
<div class="form-group" >


   
First Name<input class="form-control" type="text" name="docfname" >

Last Name<input class="form-control" type="text" name="doclname" >

Email<input class="form-control" type="text"name="docemail">

Password<input class="form-control" type="password" name="docpass" >
